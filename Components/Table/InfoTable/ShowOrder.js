...
function ShowOrder() {
    ...
    return (
        <Button full disabled={totalCount > 0 ? false : true} success style={{ position: 'absolute', bottom: 5, alignSelf: 'flex-end', width: width, borderRadius: 10, opacity: totalCount > 0 ? 1 : 0 }}>
